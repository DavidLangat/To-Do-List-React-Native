...
import { StyleSheet, View, Text,TouchableOpacity, TextInput, Button, Pressable, Platform, PermissionsAndroid } from "react-native";
    ...
    try {
      const granted = await PermissionsAndroid.request(
        PermissionsAndroid.PERMISSIONS.ACCESS_FINE_LOCATION,
        {
          ...
          message:'This add neds to access your location'
        },
